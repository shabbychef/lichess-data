...
pastes together a bunch of variant csv files, rejecting abnormal games, 
and sorting by datetime.

-O OUTFILE --outfile=OUTFILE     Give the outfile as csv or fst [default: all_antichess.fst]
